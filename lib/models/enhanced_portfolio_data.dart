...
class EnhancedPortfolioData {
  ...
  static final List<ProjectModel> projects = [
    ...
    ProjectModel(
      ...
      description: 'Gamified e-learning platform with interactive courses, live classes, quizzes, and progress tracking for students and educators.',
      imageUrl: 'https://images.unsplash.com/photo-1501504905252-473c47e087f8?w=400&h=300&fit=crop',
      features: [
        'Interactive video courses with bookmarks',
      ...
      techStack: ['Flutter', 'Firebase', 'Agora SDK', 'GetX', 'Hive'],
      githubUrl: 'https://github.com/karthick-dev/edulearn',
      liveUrl: 'https://edulearn-demo.web.app',
      createdAt: DateTime(2023, 6, 10),
      status: ProjectStatus.completed,
      likes: 312,
      views: 2156,
      category: 'Education',
      tags: ['Mobile App', 'EdTech', 'Live Streaming', 'SaaS'],
      screenshots: [],
    ),
    ProjectModel(
      id: 'proj_004',
      title: 'FoodHub - Restaurant Management System',
      description: 'Complete restaurant management solution with POS, inventory management, online ordering, and delivery tracking.',
      ...
      techStack: ['Flutter', 'Node.js', 'MongoDB', 'Redis', 'Stripe', 'Google Maps API'],
      createdAt: DateTime(2024, 3, 5),
      status: ProjectStatus.inProgress,
      likes: 87,
      views: 645,
      category: 'Business',
      tags: ['Mobile App', 'POS', 'Restaurant Tech', 'In Progress'],
      screenshots: [],
    ),
    ProjectModel(
      id: 'proj_005',
      title: 'FitPro - AI Fitness Coach',
      description: 'AI-powered fitness app with personalized workout plans, nutrition tracking, and virtual personal trainer.',
      ...
      techStack: ['Flutter', 'TensorFlow Lite', 'Firebase', 'HealthKit', 'Google Fit'],
      githubUrl: 'https://github.com/karthick-dev/fitpro',
      createdAt: DateTime(2023, 11, 18),
      status: ProjectStatus.completed,
      likes: 421,
      views: 3102,
      category: 'Health & Fitness',
      tags: ['Mobile App', 'AI/ML', 'Computer Vision', 'HealthTech'],
      screenshots: [],
    ),
    ProjectModel(
      id: 'proj_006',
      title: 'SmartHome Hub - IoT Controller',
      description: 'Unified smart home control app supporting multiple IoT protocols and devices with automation and voice control.',
      ...
      techStack: ['Flutter', 'MQTT', 'WebSocket', 'Node-RED', 'InfluxDB'],
      createdAt: DateTime(2024, 2, 12),
      status: ProjectStatus.inProgress,
      likes: 156,
      views: 892,
      category: 'IoT',
      tags: ['Mobile App', 'IoT', 'Smart Home', 'Automation'],
      screenshots: [],
    ),
  ];
